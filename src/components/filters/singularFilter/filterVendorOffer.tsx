...
const VendorOfferModel: React.FC<CompanyName> = ({  Vendor, vendorName }) => {
	const {
		register,
		handleSubmit,
		watch,
  ...
  const items = vendorDetail?.offers;
...
VendorOfferModel.displayName = "VendorOfferModel";
export default VendorOfferModel;
