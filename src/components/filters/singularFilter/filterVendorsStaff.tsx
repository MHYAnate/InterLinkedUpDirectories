...
const VendorStaffModel: React.FC<Vendor> = ({ Vendor, vendorName }) => {
	const {
		register,
		handleSubmit,
		watch,
  ...
  const items = vendorDetail?.staffs;
...
VendorStaffModel.displayName = "VendorStaffModel";
export default VendorStaffModel;
