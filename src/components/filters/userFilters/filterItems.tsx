...
export default function FilterItems() {
	...
	function RenderAvailableGoods() {
		...
		return filteredFirebaseSearchInputList?.map((stock: any) => (
			<div className={styles.stockRenderCover} key={`${stock.title}${stock.price}`}>
			<div className={styles.stockName}>{stock.title}</div>
			<div className={styles.stockSeperatorCover}>
	...
	return (
		<div className={styles.filterBodyCover}>
			<div className={styles.filterPostCover}>
			<div className={styles.post}>Filter Items on Market Space</div>
			...
			<div className={styles.displayFilter}>
              ...
              <div className={styles.noPost}>You are seeing this Models, Becouse there are no posted Items Yet on the Market Space</div>
              <div className={styles.rendering}>{RenderAvailableModelGoods()}</div></div>)}
					</div>
				)}
			</div>
		</div>
