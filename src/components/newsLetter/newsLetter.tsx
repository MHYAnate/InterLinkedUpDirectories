						...
						<div className={styles.title}>
							<div className={styles.flextitle}>
								...
								<p className={styles.boldP}>
										Join us on our mission to simplify service discovery and empower individuals by providing a user-friendly platform to find and showcase the perfect Business Connections
									</p>
									<p className={styles.boldP}>
